...
//* Remove default stylesheet path
remove_action( 'genesis_meta', 'genesis_load_stylesheet' );

//* Load minified stylesheet
function prefix_load_stylesheet() {
	wp_enqueue_style( 'prefix-stylesheet', get_stylesheet_directory_uri() . '/css/main.min.css', array(), CHILD_THEME_VERSION );
}
add_action( 'genesis_meta', 'prefix_load_stylesheet' );
